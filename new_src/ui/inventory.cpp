...
Inventory::Inventory(wgpu::Device device, wgpu::TextureFormat texture_format, uint32_t width, uint32_t height) {
    // ... vertex buffer, pipeline, and bind group creation ...
}

void Inventory::draw(wgpu::RenderPassEncoder render_pass) {
    // ... draw logic ...
}
