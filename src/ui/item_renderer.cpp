...
namespace flint
{
    namespace ui
    {
            ...
            WGPUBindGroupLayout ui_texture_bind_group_layout)
        {
            ...
            shader_desc.label = flint_utils::makeStringView("Item Renderer Shader");
            WGPUShaderModule shader_module = wgpuDeviceCreateShaderModule(device, &shader_desc);

            // --- Render Pipeline ---
            WGPUPipelineLayoutDescriptor layout_desc = {};
            layout_desc.label = flint_utils::makeStringView("Item Renderer Pipeline Layout");
            ...
            pipeline_desc.label = flint_utils::makeStringView("Item Renderer Pipeline");
            ...
            pipeline_desc.vertex.entryPoint = flint_utils::makeStringView("vs_main");
            ...
            buffer_desc.label = flint_utils::makeStringView("Item Renderer Vertex Buffer");
            ...
            const std::vector<std::tuple<ItemStack, glm::vec2, float, glm::vec4>> &items)
        {
            ...
            if (required_size > buffer_size)
            {
                ...
                WGPUBufferDescriptor buffer_desc = {};
                buffer_desc.label = flint_utils::makeStringView("Item Renderer Vertex Buffer (Resized)");
                buffer_desc.size = buffer_size;
                buffer_desc.usage = WGPUBufferUsage_Vertex | WGPUBufferUsage_CopyDst;
                buffer_desc.mappedAtCreation = false;
                vertex_buffer = wgpuDeviceCreateBuffer(device, &buffer_desc);
