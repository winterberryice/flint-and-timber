...
namespace flint
{
    namespace graphics
    {
        ...
        void SelectionRenderer::update(const std::optional<glm::ivec3> &selected_block)
        {
            ...
            {
                return; // No change, no need to update buffers
            }
            ...
            auto add_quad = [&](const glm::vec3 &v1, const glm::vec3 &v2, const glm::vec3 &v3, const glm::vec3 &v4, const glm::vec3 &normal)
            {
                ...
                vertices.push_back({v1, normal, {0, 0}});
                vertices.push_back({v2, normal, {1, 0}});
                vertices.push_back({v3, normal, {1, 1}});
                vertices.push_back({v4, normal, {0, 1}});
            ...
            float t = 0.02f;  // thickness of the outline
            float e = 0.002f; // epsilon to avoid z-fighting
            ...
            // Top face (+Y)
            {
                ...
                add_quad(v1, v2, v2_in, v1_in, normal);
                add_quad(v2, v3, v3_in, v2_in, normal);
                add_quad(v3, v4, v4_in, v3_in, normal);
                add_quad(v4, v1, v1_in, v4_in, normal);
            }
